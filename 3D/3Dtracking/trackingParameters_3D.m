function trackParam = trackingParameters_3D
...
parameters.minSearchRadius = 0.4; %minimum allowed search radius. The search radius is calculated on the spot in the code given a feature's motion parameters. If it happens to be smaller than this minimum, it will be increased to the minimum.
